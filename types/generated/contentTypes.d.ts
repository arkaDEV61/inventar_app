...
export interface ApiArticleUnitArticleUnit extends Struct.CollectionTypeSchema {
  collectionName: 'article_units';
  info: {
    description: '';
    displayName: 'Article Unit';
    pluralName: 'article-units';
    singularName: 'article-unit';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    acronim: Schema.Attribute.String;
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    amount_old: Schema.Attribute.String;
    article_unit: Schema.Attribute.Relation<
      'manyToOne',
      'api::article-unit.article-unit'
    >;
...
export interface ApiClientClient extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    pdv_number: Schema.Attribute.String;
...
export interface ApiReportReport extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    article_reports: Schema.Attribute.Component<
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::article-unit.article-unit': ApiArticleUnitArticleUnit;
